    ...
    for (let i = 0; i < greatDealsProducts.length; i++) {
        ...
        for (let j = 0; j < featuredProducts.length; j++) {
            ...
            if (greatDealsProductClassNameList[i] === freaturedProductClassName) {
                ...
                let featuredProductUnit = `${productUnit[j].textContent}`;
...
//             if (ctaProductName[0] === `Quality and` || ctaProductName.length > 1) {
//                 callToActionProductName.textContent = `${productName[i].textContent}`;
//             } else {
//                 callToActionProductName.textContent = `Branded ${productName[i].textContent}`;
//             }
...
//             callToActionOfferPrice.textContent = `${currentPrice[i].textContent}`;
//             callToActionOfferMessage.textContent = `Offer ${callToActionProductType.textContent}`;
//         }
//     }
// })();
